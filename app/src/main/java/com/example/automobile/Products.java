...
public class Products extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.category:
                        break;
                    case R.id.search:
                        startActivity(new Intent(Products.this, Search.class));
                        break;
                    case R.id.company:
                        startActivity(new Intent(Products.this,Company.class));
                        break;
                    case R.id.account:
                        startActivity(new Intent(Products.this, AccountLogin.class));
                        break;
        ...
        list = new ArrayList<>();
        productAdaptor = new ProductAdaptor(this,list);
